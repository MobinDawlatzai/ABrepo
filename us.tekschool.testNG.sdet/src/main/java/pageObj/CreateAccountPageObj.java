...
public class CreateAccountPageObj extends Base {
	...
	public void enterCreatEmail(String email) {
	...
	public void fillPersonalInformation(String fName, String lname, String pass, String emailValues) {

		firstName.sendKeys(fName);
		lastName.sendKeys(lname);
		DriverUtility.clearText(email);
		email.sendKeys(emailValues);
